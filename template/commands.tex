...
%% COMMENTS
\definecolor{mycolorFede}{HTML}{FF0000}
\newcommand{\fede}[2]{{\color{mycolorFede}\sout{#1}#2}}
\newcommand{\fedecom}[1]{\todo[color=mycolorFede!40, inline]{{\it Fede:} #1}}


\definecolor{mycolorStudent}{HTML}{00FF00}
\newcommand{\student}[2]{{\color{mycolorStudent}\sout{#1}#2}}
\newcommand{\studentcom}[1]{\todo[color=mycolorStudent!40, inline]{{\it Student:} #1}}